...
Skills and knowledge base to ship on Solana — Idea to Launch. 25 journey skills, 81 repos, 73 ecosystem skills, 53 MCP servers.
...
cli/
  ...
  data/
    clonable-repos.json     81 repos (Solana official, SendAI, Metaplex, DeFi, etc.)
