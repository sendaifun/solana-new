...
Skills and knowledge base to ship on Solana — Idea to Launch. 25 journey skills, 89 repos, 77 ecosystem skills, 53 MCP servers.
...
cli/
  ...
  data/
    clonable-repos.json     89 repos (Solana official, SendAI, Metaplex, DeFi, etc.)
