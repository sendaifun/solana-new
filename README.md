...
[![Skills](https://img.shields.io/badge/skills-83-blueviolet)](#ecosystem-catalog)
...
The open-source platform behind [solana.new](https://solana.new) — 25 journey skills that take you from "what should I build?" to a shipped, funded product on Solana. Backed by 106 repos, 83 ecosystem skills, 36 MCP servers, 515+ curated ideas, and a comprehensive Solana knowledge base.
...
cli/
  ...
  data/
    ...
    solana-skills.json      83 skills (15 official + 68 community)
